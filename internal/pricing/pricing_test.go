...
func TestReadCompute(t *testing.T) {
	path := fmt.Sprintf("%s/%s", os.Getenv("GOPATH"),
		"src/github.com/itsubaki/hermes/internal/pricing/_json/ec2/20190513190834/ap-northeast-1.json",
	)
...
// 	path := fmt.Sprintf("%s/%s", os.Getenv("GOPATH"),
// 		"src/github.com/itsubaki/hermes/internal/pricing/_json/cache/20190507224731/ap-northeast-1.json",
// 	)
// 	buf, err := ioutil.ReadFile(path)
// 	if err != nil {
// 		t.Errorf("read body: %v", err)
...
// 	path := fmt.Sprintf("%s/%s", os.Getenv("GOPATH"),
// 		"src/github.com/itsubaki/hermes/internal/pricing/_json/rds/20190510215946/ap-northeast-1.json",
// 	)
// 	buf, err := ioutil.ReadFile(path)
// 	if err != nil {
// 		t.Errorf("read body: %v", err)
